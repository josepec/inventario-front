  ...
  template: `
    <aside class="hidden md:flex flex-col h-full w-60 bg-[#111111] border-r border-[#1e1e1e]">
      ...
      <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        ...
        <a routerLink="/app/comics" routerLinkActive="bg-[#7c3aed1a] text-[#8b5cf6]" [routerLinkActiveOptions]="{ exact: true }"
          class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-[#a0a0a0]
        ...
        <a routerLink="/app/comics/novedades" routerLinkActive="bg-[#7c3aed1a] text-[#8b5cf6]"
          class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-[#a0a0a0]
                 hover:bg-[#1f1f1f] hover:text-white transition-colors duration-150">
          <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            <path stroke-linecap="round" stroke-linejoin="round"
              d="M12 7.5V6a3.75 3.75 0 10-7.5 0v1.5m0 0A2.25 2.25 0 002.25 9.75v9a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18.75v-9A2.25 2.25 0 0019.5 7.5h-15zm6.75 3.75h3" />
          </svg>
          <span>Novedades</span>
        </a>
